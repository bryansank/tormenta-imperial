...
const _STRINGS := {
	"es": {
		...
		"LBL_TOUCH_CONTROLS": "Controles tactiles en pantalla",
		"OPT_TOUCH_AUTO": "Automatico (solo pantalla tactil)",
		"OPT_TOUCH_ALWAYS": "Siempre",
		"OPT_TOUCH_NEVER": "Nunca",
		"BTN_RESET_UI": "Restablecer posicion de la interfaz",
		"LBL_MOVE_HINT": "Cambia el edificio de sitio. No cuesta nada y conserva su nivel.",
		"FMT_NOT_ENOUGH_OF": "Falta %s: tienes %d y hacen falta %d.",

		# Helper
		"BTN_HELP": "AYUDA",
		"LBL_HELP_RESOURCES_POOL": "Tus recursos: oro y madera (luego acero y petroleo). La barra de abajo es el almacen: un solo tope para los cuatro juntos.",
		"LBL_HELP_CAMERA_DESKTOP": "Camara: WASD o arrastra con el boton central para moverla; rueda para el zoom; Q y E para rotar.",
	...
	"en": {
		...
		"LBL_TOUCH_CONTROLS": "On-screen touch controls",
		"OPT_TOUCH_AUTO": "Automatic (touchscreen only)",
		"OPT_TOUCH_ALWAYS": "Always",
		"OPT_TOUCH_NEVER": "Never",
		"BTN_RESET_UI": "Reset interface layout",
		"LBL_MOVE_HINT": "Relocate the building. Free, and it keeps its level.",
		"FMT_NOT_ENOUGH_OF": "Not enough %s: you have %d and need %d.",

		# Helper
		"BTN_HELP": "HELP",
		"LBL_HELP_RESOURCES_POOL": "Your resources: gold and wood (later steel and oil). The bar below is the storage: one shared cap for all four.",
		"LBL_HELP_CAMERA_DESKTOP": "Camera: WASD or middle-mouse drag to pan; wheel to zoom; Q and E to rotate.",
