...
const _STRINGS := {
	"es": {
		...
		"STORM_TITHE_DURING_AUDIT": "Los Tasadores no cobran hoy: sus oleadas ya estan en la puerta.",
		"STORM_TITHE_TOWER_CREWS": "Las torres encienden los reflectores y arman sus posiciones (+%d en la linea).",
		"MSG_DEFENSE_AUTO_WON": "Con el ejercito fuera, la guarnicion repelio sola a los Tasadores: %d bajas en %d rondas.",
		"MSG_DEFENSE_AUTO_LOST": "Con el ejercito fuera, la guarnicion cayo ante los Tasadores: %d bajas en %d rondas.",
		...
		"MSG_DEPLOY_CAP_EXCEEDED": "Superas el tope de despliegue.",
		"MSG_UNITS_UNAVAILABLE": "No tienes tantas unidades disponibles.",
		"MSG_EXPEDITION_ACTIVE": "Ya hay una expedicion en marcha.",
		"MSG_ENCOUNTER_ACTIVE": "Hay un combate en curso.",
		"MSG_AUDIT_BLOCKS_EXPEDITION": "La Auditoria Final esta en marcha: la guarnicion no sale.",
	...
	"en": {
		...
		"STORM_TITHE_DURING_AUDIT": "No Tithe today: their waves are already at the gate.",
		"STORM_TITHE_TOWER_CREWS": "The towers light their reflectors and man their positions (+%d on the line).",
		"MSG_DEFENSE_AUTO_WON": "With the army away, the garrison repelled the Assessors alone: %d casualties in %d rounds.",
		"MSG_DEFENSE_AUTO_LOST": "With the army away, the garrison fell to the Assessors: %d casualties in %d rounds.",
		...
		"MSG_DEPLOY_CAP_EXCEEDED": "That is more than the deploy cap allows.",
		"MSG_UNITS_UNAVAILABLE": "You do not have that many units available.",
		"MSG_EXPEDITION_ACTIVE": "An expedition is already under way.",
		"MSG_ENCOUNTER_ACTIVE": "A battle is in progress.",
		"MSG_AUDIT_BLOCKS_EXPEDITION": "The Final Audit is under way: the garrison stays home.",
